        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url('dist/img/ic_'.$this->uri->segment(1).'.png');?>" alt="User profile picture">
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <form action="<?php echo site_url('admin/profile/edit/'.($user->admin_id)) ?>" role="form" method="POST" enctype="multipart/form-data" class="form-horizontal">
